      ...
      <div className="container mx-auto px-4 max-w-6xl">
        <div className="flex flex-col md:flex-row items-start md:items-end justify-between mb-12 gap-4">
          <div className="max-w-2xl">
            <h2 className="text-3xl md:text-5xl font-bold tracking-tight text-slate-900 mb-4 leading-tight">Consult a Doctor Today</h2>
            <p className="text-base md:text-lg text-slate-600 font-medium">Don&apos;t wait. Book an available appointment for today and get on the path to recovery sooner.</p>
          </div>

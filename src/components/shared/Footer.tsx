...
export function Footer() {
  return (
    <footer className="bg-[#5696C7] text-white/95 border-t border-white/10 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 max-w-7xl pt-16 md:pt-20 pb-12 relative z-10">
                        ...
                        <Tag
                          ...
                          className={`text-[14px] hover:translate-x-1 inline-block transition-transform duration-200 ${
                            "accent" in link && link.accent
                              ...
                              : "text-white/95 hover:text-white hover:underline"
                          }`}
                        >
                          {link.label}
                        </Tag>
          ...
          <div id="contact" className="grid grid-cols-1 md:grid-cols-3 gap-6">
             <div className="flex items-start gap-4 p-4 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 transition-colors">
                ...
                <div>
                  ...
                  <p className="text-sm text-white/95">Tech Hub, India</p>
                </div>
             </div>
             <div className="flex items-start gap-4 p-4 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 transition-colors">
                <div className="w-10 h-10 rounded-full bg-white/10 text-white flex items-center justify-center shrink-0">
                ...
                <div>
                  ...
                  <a href="tel:8235351897" className="text-sm text-white/95 hover:text-white hover:underline block mb-0.5">+91 82353 51897</a>
                  <p className="text-xs text-white/90 font-semibold flex items-center gap-1"><Clock className="w-3 h-3" /> 24/7 Support</p>
                </div>
             </div>
             <div className="flex items-start gap-4 p-4 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 transition-colors">
                <div className="w-10 h-10 rounded-full bg-white/10 text-white flex items-center justify-center shrink-0">
                ...
                <div>
                  ...
                  <a href="mailto:support@jivnicare.com" className="text-sm text-white/95 hover:text-white hover:underline block">support@jivnicare.com</a>
                </div>
             </div>
          </div>
        </div>
        ...
        {/* Bottom Bar */}
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-6 text-[13px] text-white/90 text-center md:text-left font-medium">

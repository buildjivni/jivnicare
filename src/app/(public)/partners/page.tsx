...
import { 
  ...
  Sparkles, Activity, Award, Clock, Check
} from "lucide-react";
...
export default function PartnersPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#F4F9FD] via-[#FBFDFE] to-[#F4F9FD] text-slate-800 font-sans selection:bg-[#5298D2]/20 selection:text-[#5298D2] relative overflow-hidden">
      ...
      <div className="absolute inset-0 w-full h-full overflow-hidden pointer-events-none z-0">
        ...
        <div className="absolute top-[-10%] right-[-10%] w-[800px] h-[800px] rounded-full bg-gradient-to-br from-[#5298D2]/8 to-[#489C66]/4 blur-[130px] opacity-70 animate-pulse duration-[8000ms]" />
        <div className="absolute bottom-[10%] left-[-15%] w-[700px] h-[700px] rounded-full bg-gradient-to-tr from-[#5298D2]/6 to-emerald-500/3 blur-[120px] opacity-60 animate-pulse duration-[12000ms]" />
      </div>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-6 space-y-8 z-10 relative text-left">
            ...
            <motion.div 
              ...
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#5298D2]/8 border border-[#5298D2]/15 text-[#5298D2] text-[10px] font-black uppercase tracking-[0.2em] shadow-sm bg-white/50 backdrop-blur-sm"
            >
            ...
            <div className="space-y-4">
              ...
              >
                ...
                for <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#5298D2] to-[#489C66] drop-shadow-sm">Trusted Doctors.</span>
              </motion.h1>
            ...
            >
              <Link href="/partners/onboard" className="flex-1 sm:flex-initial">
                <Button className="w-full sm:min-w-[220px] h-14 rounded-2xl bg-gradient-to-r from-[#5298D2] to-[#489C66] hover:from-[#4383be] hover:to-[#3e8858] text-white font-bold text-sm shadow-lg shadow-sky-500/10 hover:shadow-sky-500/15 transition-all hover:-translate-y-0.5 active:translate-y-0 duration-300 flex items-center justify-center gap-2 border-none">
                  Join Partner Network
                  <ArrowRight className="w-4 h-4" />
                </Button>
              </Link>
              <Link href="/partners/login" className="flex-1 sm:flex-initial">
                <Button className="w-full sm:min-w-[185px] h-14 rounded-2xl bg-white/80 hover:bg-white border border-[#5298D2]/20 hover:border-[#5298D2]/35 text-[#5298D2] font-bold text-sm hover:-translate-y-0.5 active:translate-y-0 transition-all duration-300 flex items-center justify-center gap-2 shadow-sm backdrop-blur-md">
                  Doctor Sign In
                </Button>
              </Link>
            </motion.div>
            ...
            >
              <div className="flex items-center gap-2"><CheckCircle2 className="w-3.5 h-3.5 text-[#489C66]" /> Unified Doctor Onboarding</div>
              <div className="flex items-center gap-2"><CheckCircle2 className="w-3.5 h-3.5 text-[#489C66]" /> Professional Queue Suite</div>
            </motion.div>
          ...
          <div className="lg:col-span-6 relative flex items-center justify-center min-h-[460px] lg:min-h-[500px]">
            ...
            {/* 3D Coordinate Parallax Box */}
            <div 
              className="relative w-full max-w-[440px] h-[440px] transition-transform duration-500 ease-out"
              style={{
            ...
            >
              ...
              <div className="absolute top-[25%] left-[25%] w-[200px] h-[200px] rounded-full bg-[#5298D2]/15 blur-[45px] -z-10 animate-pulse" />
              ...
              <div className="absolute inset-[-30px] rounded-full border border-dotted border-[#5298D2]/8 animate-[spin_150s_linear_infinite] pointer-events-none" />
              ...
              <motion.div 
                ...
                className="absolute top-[12%] left-[8%] w-[84%] bg-white/90 backdrop-blur-2xl rounded-3xl border border-white/60 p-6 shadow-[0_25px_50px_rgba(82,152,210,0.08)] z-20 hover:border-[#5298D2]/20 transition-colors"
                style={{ transform: "translateZ(30px)" }}
              >
                <div className="flex items-center gap-4">
                  <div className="relative">
                    <div className="w-14 h-14 rounded-2xl bg-[#E0F2FE] flex items-center justify-center border border-[#5298D2]/10">
                      <Stethoscope className="w-6 h-6 text-[#5298D2]" />
                    </div>
                  ...
                  <div>
                    <div className="flex items-center gap-1.5">
                      ...
                      <span className="inline-flex items-center justify-center w-4 h-4 bg-[#5298D2]/10 rounded-full">
                        <Check className="w-2.5 h-2.5 text-[#5298D2]" />
                      </span>
                    </div>
                    <p className="text-slate-500 text-xs font-semibold mt-1">General Medicine &bull; Patna City</p>
                  </div>
                </div>
                ...
                <div className="mt-5 pt-4 border-t border-slate-100/80 flex items-center justify-between text-xs text-slate-500">
                  <div className="flex items-center gap-1.5">
                    <Award className="w-3.5 h-3.5 text-[#5298D2]" />
                    <span>NMC ID: <span className="font-bold text-slate-700">84729-BR</span></span>
                  </div>
                  <span className="px-2 py-0.5 bg-emerald-50 border border-emerald-100 text-emerald-600 rounded text-[9px] font-bold">
                    ACTIVE REGISTRY
                  </span>
                </div>
              </motion.div>
              ...
              >
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span className="px-2 py-0.5 bg-[#5298D2]/10 border border-[#5298D2]/20 text-[#5298D2] rounded-full text-[9px] font-bold flex items-center gap-1">
                    <span className="relative flex h-1.5 w-1.5">
                      <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#5298D2] opacity-75"></span>
                      <span className="relative inline-flex rounded-full h-1.5 w-1.5 bg-[#5298D2]"></span>
                    </span>
                    LIVE
                  </span>
                </div>
                  ...
                  {[
                    ...
                    <div key={idx} className={`p-2 rounded-xl border flex items-center justify-between transition-all duration-200 ${p.active ? 'bg-sky-50/40 border-sky-100' : 'bg-slate-50/50 border-slate-100/85'}`}>
                      <div className="flex items-center gap-2">
                        <span className={`text-[9px] font-bold px-1.5 py-0.5 rounded ${p.active ? 'bg-[#5298D2]/10 text-[#5298D2]' : 'bg-slate-200/50 text-slate-500'}`}>{p.token}</span>
                        <span className={`text-[11px] font-bold ${p.active ? 'text-slate-800' : 'text-slate-500'}`}>{p.name}</span>
                      </div>
                      <span className={`text-[9px] font-bold ${p.active ? 'text-emerald-600 animate-pulse' : 'text-slate-400'}`}>{p.time}</span>
                    </div>
                  ))}
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div className="p-2 rounded-xl bg-slate-50/60 border border-slate-100 text-left">
                    ...
                    <p className="text-xs font-extrabold text-[#5298D2] mt-0.5">8 Mins</p>
                  </div>
                  <div className="p-2 rounded-xl bg-slate-50/60 border border-slate-100 text-left">
              ...
              <motion.div 
                ...
                className="absolute bottom-[18%] right-[-6%] z-40 bg-white border border-[#5298D2]/20 backdrop-blur-2xl rounded-2xl p-3 flex items-center gap-2.5 shadow-lg text-left"
                style={{ transform: "translateZ(90px)" }}
              >
                <div className="w-8 h-8 rounded-xl bg-sky-50 border border-sky-100 flex items-center justify-center">
                  <ShieldCheck className="w-4 h-4 text-[#5298D2]" />
                </div>
                <div>
                  <p className="text-[8px] font-bold text-[#5298D2] uppercase tracking-wider">Verification</p>
      ...
      <section id="infrastructure" className="py-20 md:py-28 relative z-10 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center max-w-2xl mx-auto mb-16 space-y-4">
            <span className="inline-flex items-center gap-1.5 px-3 py-1 bg-sky-100/50 border border-sky-200/50 text-[#5298D2] rounded-full text-[10px] font-bold uppercase tracking-widest bg-white">
              <Sparkles className="w-3.5 h-3.5 text-[#5298D2]" /> Platform Architecture
            </span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              {
                icon: <Building2 className="w-5 h-5 text-[#5298D2]" />,
                ...
                border: "hover:border-[#5298D2]/35"
              },
              {
                icon: <Activity className="w-5 h-5 text-[#489C66]" />,
                ...
                border: "hover:border-[#489C66]/35"
              },
              {
                icon: <ShieldCheck className="w-5 h-5 text-[#489C66]" />,
              ...
              <motion.div 
                ...
                className={`group rounded-[2rem] p-8 bg-white border border-slate-100/90 shadow-[0_12px_30px_rgba(82,152,210,0.03)] hover:shadow-[0_20px_45px_rgba(82,152,210,0.08)] transition-all duration-300 ${prop.border} text-left`}
              >
      ...
      <section className="py-20 md:py-28 border-t border-[#5298D2]/10 bg-gradient-to-b from-[#F7FBFE] to-[#F1F7FC] relative z-10 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center max-w-2xl mx-auto mb-16 space-y-4">
            <span className="inline-flex items-center gap-1.5 px-3 py-1 bg-teal-50 border border-[#489C66]/20 text-[#489C66] rounded-full text-[10px] font-bold uppercase tracking-widest bg-white">
              <Clock className="w-3.5 h-3.5 text-[#489C66]" /> Simple Onboarding Flow
            </span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8 relative">
            ...
            <div className="hidden md:block absolute top-8 left-[16%] right-[16%] h-[1px] bg-gradient-to-r from-[#5298D2]/15 via-[#489C66]/15 to-transparent -z-10" />
            ...
            {[
              ...
              >
                <div className="w-16 h-16 mx-auto bg-white border border-[#5298D2]/20 rounded-2xl flex items-center justify-center shadow-sm">
                  <span className="text-lg font-black text-transparent bg-clip-text bg-gradient-to-br from-[#5298D2] to-[#489C66]">{stepItem.num}</span>
                </div>
          ...
          <div className="mt-16 text-center">
            <Link href="/partners/onboard">
              <Button className="h-16 px-10 rounded-2xl bg-gradient-to-r from-[#5298D2] to-[#489C66] hover:from-[#4383be] hover:to-[#3e8858] text-white font-bold text-sm shadow-xl shadow-sky-500/10 hover:shadow-sky-500/15 transition-all hover:-translate-y-0.5 active:translate-y-0 duration-300 border-none">
      ...
      {/* ── FOOTER DISCLAIMER ────────────────────────────────────────────── */}
      <footer className="py-12 border-t border-[#5298D2]/10 bg-[#E8F2FA] text-center relative z-10 px-4">
        <div className="max-w-6xl mx-auto flex flex-col items-center gap-4 text-slate-650">
          ...
          <div className="text-[10px] text-slate-500 font-bold mt-2">
            &copy; {new Date().getFullYear()} JivniCare. All rights reserved. &bull; <Link href="/privacy" className="hover:text-[#5298D2] transition-colors">Privacy Policy</Link> &bull; <Link href="/terms" className="hover:text-[#5298D2] transition-colors">Terms of Service</Link>
          </div>
        </div>
      </footer>

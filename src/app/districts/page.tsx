    ...
    <main className="min-h-screen bg-[#f7f9fc] pb-20">
      ...
      <div className="container mx-auto max-w-5xl px-4 py-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-10">
          {FEATURED_DISTRICTS.map((district) => (
            <Link
              ...
              className="group bg-white border border-slate-100 rounded-3xl p-5 hover:shadow-md hover:border-[#205E98]/25 transition-all"
            >
              <div className="w-10 h-10 bg-[#205E98]/8 rounded-2xl flex items-center justify-center mb-3">
                <MapPin className="w-5 h-5 text-[#205E98]" />
              </div>
              <p className="font-bold text-slate-900 group-hover:text-[#205E98] transition-colors">
                {district}
              </p>
        ...
        <h2 className="text-xl font-bold text-slate-900 mb-5 flex items-center gap-2">
          <Search className="w-5 h-5 text-[#205E98]" /> All Districts
        </h2>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-2">
            {BIHAR_DISTRICTS.map((district) => (
              <Link
                ...
                className="text-sm font-medium text-slate-700 hover:text-[#205E98] hover:bg-[#205E98]/5 px-3 py-2.5 rounded-xl transition-all"
              >
                {district}
              </Link>
            ))}

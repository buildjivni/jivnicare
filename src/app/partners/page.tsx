    ...
    <div className="min-h-screen bg-slate-50 pt-16">
      <div className="max-w-6xl mx-auto px-4 md:px-6">
        ...
        <section className="text-center max-w-3xl mx-auto py-16 md:py-24">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#205E98]/10 text-[#205E98] text-sm font-bold mb-6">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link href="/login">
              <Button className="h-14 px-8 rounded-2xl bg-[#205E98] hover:bg-[#184a7a] text-white font-bold text-base w-full sm:w-auto transition-all shadow-lg shadow-[#205E98]/20 hover:-translate-y-0.5">
                Onboard as a Doctor
              </Button>
            </Link>
            <Link href="/login">
        ...
        <section className="py-16 grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            {
              icon: <Users className="w-6 h-6 text-[#205E98]" />,
